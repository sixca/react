...
주의사항 - java의 import가 아님
          ...
          import java.util.List (java에서는 이렇게)

          List<String> list; 라고 쓰면 List의 풀네임을 써야 맞는다
          java.util.List<String> list 그런데 너무 기니까
          앞에처럼 짧게 쓰고 전체 풀네임은 위의 import구문으로
          확인하라는 의미 라이브러리 자체는 이미 불러와있는 상태이다.
*/
